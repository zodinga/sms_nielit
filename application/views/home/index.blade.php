  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row placeholders">
      <div class="col-xs-6 col-sm-3 placeholder">
        <div class="chart">
          <div class="pie-thychart" data-set='[["Male", <?php echo $student_sex_male;?>], ["Female",<?php echo $student_sex_female;?>],["Unknown",<?php echo $student_sex_unknown;?>]]' data-colors="#6699FF,#CC99FF,#47B224"></div>
        </div>
        <h4>Sex</h4>
      ...
      <div class="col-xs-6 col-sm-3 placeholder">
        <div class="chart">
          <div class="pie-thychart" data-set='[["LongTerm", <?php echo $student_long; ?>], ["ShortTerm",<?php echo $student_short; ?>]]' data-colors="#6699FF,#CC99FF"></div>
        </div>
        <h4>Courses</h4>
