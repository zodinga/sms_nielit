...
<section class="module">
    ...
    <div class="module-body">
        <div class="row-fluid">
            <div class="span3">
                <p class="muted">Total No.of Students: <strong>{{$student_no}}</strong></p>

                <div class="progress progress-warning">
                    <div class="bar" style="width: {{$per_male}}%;">Male: {{$per_male}}%</div>
                </div>
                <div class="progress progress-primary">
                    <div class="bar" style="width: {{$per_female}}%;">Female: {{$per_female}}%</div>
                </div>
            </div>
            <div class="span3">
                <p class="muted">Courses(Longterm/Shorterm)</strong></p>

                <div class="progress">
                    <div class="bar" style="width: {{$per_longterm}}%;">Longterm: {{$per_longterm}}%</div>
                </div>
                <div class="progress progress-info">
                    <div class="bar" style="width: {{$per_shortterm}}%;">Short term: {{$per_shortterm}}%</div>
                </div>
            </div>
            <div class="span3">
                <p class="muted">Category</strong></p>
                <div class="progress">
                    <div class="bar" style="width: {{$per_st}}%;">ST: {{$per_st}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_sc}}%;">SC: {{$per_sc}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_obc}}%;">OBC: {{$per_obc}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_gen}}%;">General: {{$per_gen}}%</div>
                </div>
            </div>
            <div class="span3">
                <p class="muted">Religion</strong></p>
                <div class="progress">
                    <div class="bar" style="width: {{$per_christian}}%;">Christian: {{$per_christian}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_hindu}}%;">Hindu: {{$per_hindu}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_mushlim}}%;">Muslim: {{$per_mushlim}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_budhist}}%;">Budhist: {{$per_budhist}}%</div>
                </div>
                <div class="progress">
                    <div class="bar" style="width: {{$per_others}}%;">Others: {{$per_others}}%</div>
                </div>
            </div>
        </div>
